...
navbarPage(h4(strong("THE REAL ESTATE EFFECTS OF MAJOR DISASTERS")),
           ...
           tabPanel(h6(strong("Introduction"), style = "color: #F26430"),
                    ...
                    tabsetPanel(id = "inside",
                                ...
                                tabPanel(h6(strong("PROJECT PURPOSE"), style = "color:#F26430;"),
                                         ...
                                         span(h4("As climate change and ongoing human events intensify both the scale and frequency of severe environmental
                                          ...
                                          the immediate and short-term impact that natural destruction and catastrophe induces on the housing market.", style = "color:#FFD166;text-align:justify")),
                                          h4(" - How is the real estate valuation market affected by natural and man-made disasters (if at all)?", style = "color:#FFD166;text-align:justify"),
                        h4(" - If that's the case, is the housing market more vulnerable to certain types of disasters?", style = "color:#FFD166;text-align:justify"),
                        h4(" - How quickly does it take to bounce back?", style = "color:#FFD166;text-align:justify"),
                        h4(" - How soon after a disaster is it the ideal time to buy a home and will the value recover?", style = "color:#FFD166;text-align:justify"),
                        h4(" - Our project explores these questions in an engaging and interactive manner.", style = "color:#FFD166;text-align:justify")),
                        column(4, " ")),
                    ...
                    h4(" - Use the month/year slider to see how these real estate valus change over time before/after the disaster.", style = "color:#FFD166;text-align:justify"),
                    h4(" - Toggle between real estate metrics like home price index (HPI), mean single family home value, and % annual HPI change.", style = "color:#FFD166;text-align:justify"),
                    h4(" - Hover over the interactive map to explore zip codes' real estates ", style = "color:#FFD166;text-align:justify"),
                    h4(" - Click on the zip code to see the home value impact of immediately before and after the disaster for that specific zip code", style = "color:#FFD166;text-align:justify"),
                    h4(" - View the complementary plots to understand how the disaster changed real estate values 12 months before and after its consequences.", style = "color:#FFD166;text-align:justify"),
                    h4(" - Read through the Insights tab to see our notable trends from our data.", style = "color:#FFD166;text-align:justify")),
                    column(4, " ")),
                    ...
                    tabPanel(h6(strong("DEFINITIONS"), style = "color:#F26430"),
                             fluidRow(column(1, " "),
                                      column(8, 
                      fluidRow(h1(" "),
                               p(strong("What is Home Price Index?", style = "font-style:italic;text-align:justify;color:black;background-color:#FFD166;padding:15px")),
                      p("Home Price Index (HPI) is a weighted sales index that incorporates average price changes in repeat sales or refinancings on the same properties.", style = "font-style:italic;text-align:justify;color:black;background-color:papayawhip;padding:15px")),
                      br(),
           ...
           tabPanel(h6(strong("Insights | Commentary"), style = "color:#F26430"),
                    ...
                    suggesting their home value resilience amid disaster."),style="color:#FFD166;font-weight:bold;font-size:14px"),
                                         ...
                                         tabPanel(
                                           ...
                                           fluidRow(""),
                                           fluidRow(column(10,
                                                           h2(em("The May 2, 2013 tornado that tore through Moore is one of the deadliest in Oklahoma's history. It was a category EF5 twister,
                                                           which is extremely rare, featuring wind speeds over 200 mph.  The natural disaster caused $2 billion in damages,
                                                                 left 24 people dead, and destroyed 300 homes."), style="color:#F26430;font-size:16px;padding:15px;background-color:white")),
                                                    column(2,)),
                                           fluidRow(" "),
                                           fluidRow(column(10,
                                         ...
                                         tabPanel(
                                           ...
                                           fluidRow(""),
                                           fluidRow(column(10,
                                                           h2(em("The Northeast Snowstorm that hit in November 2014 was especially disastrous for the east coast of the United States.
                                                           However, Buffalo, NY had remnants from the snowstorm eight months afterwards.
                                                           The storm required more manpower than any other snowstorm within New York state."), style="color:#F26430;font-size:16px;padding:15px;background-color:white")),
                                                    column(2,)),
                                           fluidRow(" "),
                                           fluidRow(column(10,
                                         ...
                                         tabPanel(
                                           ...
                                           fluidRow(""),
                                           fluidRow(column(10,
                                                           h2(em("The Deepwater Horizon oil spill, also known as the BP oil spill, was a disaster in the Gulf of Mexico on BP operated Macondo Prospect that began in April 2010,
                                                           but the well was not sealed until September 2010. It is deemed one of the largest environmental disasters in US history."), style="color:#F26430;font-size:16px;padding:15px;background-color:white")),
                                                    column(2,)),
                                           fluidRow(" "),
